...
void Bureaucrat::signForm(AForm& form)
{
	try
	{
		if (form.isSigned() || this->grade <= form.reqGradeToSign())
			std::cout << this->name << " signed " << form.getName() << std::endl;
		else 
		{
			throw Bureaucrat::GradeTooLowException(this->name + " couldn't sign " + form.getName()
			+ " because he doesn't have the required grade to sign!!");
		}
	}
	catch(const Bureaucrat::GradeTooLowException& e)
	{
...
void	Bureaucrat::executeForm(AForm const & form)
{
	try
	{
		if (this->grade <= form.reqGradeToSign() && this->grade <= form.reqGradeToExec())
			std::cout << this->name << " executed " << form.getName() << std::endl;
		else
			throw Bureaucrat::GradeTooLowException("this bureaucrat can't executed this form !!");
	}
	catch (const Bureaucrat::GradeTooLowException& e)
	{
